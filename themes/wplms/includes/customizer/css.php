...
$dom_array = array(
    ...
    'login_light_color'=> array(
                            'element' => '#close_full_popup:before,#vibe_bp_login ul+ul li a',
                            'css' => 'color'
                            ),
    'login_dark'=> array(
    ...
    'login_dark_color'=> array(
                            'element' => '#vibe_bp_login .fullscreen_login label,#vibe_bp_login label',
                            'css' => 'color'
                            ),
    'h1_font' => array(
                            'element' => 'h1',
  ...
  'footer_color'  => array(
                            ...
                            footer .ninja-forms-field, 
                            footer .wpcf7 input.wpcf7-text, 
                            footer #s,.footerwidget .widget_course_list li h6,.footerwidget .widget_course_list li h6 span,
                            footer .chosen-container.chosen-with-drop .chosen-drop,
                            footer .chosen-container-active.chosen-with-drop .chosen-single, 
                            footer .chosen-container-single .chosen-single',
                            'css' => 'color'
            ...
            case 'padding-top-bottom':
             ...
             case 'primary':
                echo '.button,input[type=button], input[type=submit],
                      ...
                      .minimal.woocommerce ul.products li a.button,.minimal.woocommerce a.button,
