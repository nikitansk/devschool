...
class WPLMS_Register{
    ...
    function wplms_enqueue_admin($hook){ 
      ...
      if(in_array($hook,array('post.php','post-new.php','edit.php','toplevel_page_wplms_options','dashboard_page_wplms-install'))){
        $flag = 0;
        ...
        wp_enqueue_script( 'admin-js', VIBE_URL .'/assets/js/old_files/vibe_admin.js');
      }
