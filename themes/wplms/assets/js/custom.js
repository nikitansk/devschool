...
jQuery(document).ready(function($){  
  ...
  if($('header.sleek').hasClass('transparent')){
      ...
      var next;
      if($('body').hasClass('bp-user') && ( $('body').hasClass('p2') || $('body').hasClass('p3') || $('body').hasClass('p4'))){
        next = $('#item-header');
  ...
  var logo_src = $('header.fix').find('#logo img').attr('src'); 
  var logo_attr = $('header.fix').find('#logo img').attr('data-alt-logo');
  ...
  $(window).scroll(function(event){
    ...
    if($('header.sleek').hasClass('fix')){
      ...
      if (typeof logo_attr !== typeof undefined && logo_attr !== false) {
        if($('header.fix').hasClass('fixed')){
          $('header.fix').find('#logo img').attr('src',logo_attr);
        }else{
          $('header.fix').find('#logo img').attr('src',logo_src);  
        }
      }
