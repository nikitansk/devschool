		...
		<p id="message-recipients">
			<span class="highlight">
				...
				<?php if ( !bp_get_the_thread_recipients() ) : ?>
					...
					<?php _e( 'You are alone in this conversation.', 'wplms_modern' ); ?>

				<?php else : ?>

					<?php printf( __( 'Conversation between %s and you.', 'wplms_modern' ), bp_get_the_thread_recipients() ); ?>

				<?php endif; ?>

			</span>

			<a class="button confirm" href="<?php bp_the_thread_delete_link(); ?>" title="<?php _e( "Delete Message", "wplms_modern" ); ?>"><?php _e( 'Delete', 'wplms_modern' ); ?></a> &nbsp;
		</p>
			...
			<div class="message-box">
				...
				<div class="message-metadata">
					...
					<div class="avatar-box">
						...
						<strong><?php _e( 'Send a Reply', 'wplms_modern' ); ?></strong>
					</div>
				...
				<div class="message-content">
					...
					<div class="submit">
						<input type="submit" name="send" value="<?php _e( 'Send Reply', 'wplms_modern' ); ?>" id="send_reply_button"/>
					</div>
