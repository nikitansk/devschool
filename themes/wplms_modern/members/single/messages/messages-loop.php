	...
	<table id="message-threads" class="messages-notices">
		<thead>
				<tr>
					...
					<th scope="col" class="thread-star"><span class="message-action-star"><span class="icon"></span> <span class="screen-reader-text"><?php _e( 'Star', 'wplms_modern' ); ?></span></span></th>
					<?php endif; ?>
					<th scope="col" class="thread-from"><?php _e( 'From', 'wplms_modern' ); ?></th>
					<th scope="col" class="thread-info"><?php _e( 'Subject', 'wplms_modern' ); ?></th>
					...
					<th scope="col" class="thread-options"><?php _e( 'Actions', 'wplms_modern' ); ?></th>
				</tr>
			</thead>
			...
			<tr id="m-<?php bp_message_thread_id(); ?>" class="<?php bp_message_css_class(); ?><?php if ( bp_message_thread_has_unread() ) : ?> unread<?php else: ?> read<?php endif; ?>">
				...
				<?php if ( 'sentbox' != bp_current_action() ) : ?>
					<td width="30%" class="thread-from">
						<?php _e( 'From:', 'wplms_modern' ); ?> <?php bp_message_thread_from(); ?><br />
						<span class="activity"><?php bp_message_thread_last_post_date(); ?></span>
					</td>
				<?php else: ?>
					<td width="30%" class="thread-from">
						<?php _e( 'To:', 'wplms_modern' ); ?> <?php bp_message_thread_to(); ?><br />
						<span class="activity"><?php bp_message_thread_last_post_date(); ?></span>
					</td>
				<?php endif; ?>

				<td width="50%" class="thread-info">
					<p><a href="<?php bp_message_thread_view_link(); ?>" title="<?php _e( "View Message", "wplms_modern" ); ?>"><?php bp_message_thread_subject(); ?></a></p>
				...
				<td width="1%" class="thread-options">
					<a class="ahref confirm" href="<?php bp_message_thread_delete_link(); ?>" title="<?php _e( "Delete Message", "wplms_modern" ); ?>"><?php _e( 'Delete', 'wplms_modern' ); ?></a> &nbsp;
				</td>
			</tr>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'Sorry, no messages were found.', 'wplms_modern' ); ?></p>
	</div>
