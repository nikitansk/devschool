...
<form action="<?php bp_the_profile_group_edit_form_action(); ?>" method="post" id="profile-edit-form" class="standard-form <?php bp_the_profile_group_slug(); ?>">
	...
	<?php do_action( 'bp_before_profile_field_content' ); ?>
		...
		<h4><?php printf( __( "Editing '%s' Profile Group", "wplms_modern" ), bp_get_the_profile_group_name() ); ?></h4>
			...
			<div<?php bp_field_css_class( 'editfield' ); ?>>
				...
				<?php if ( bp_current_user_can( 'bp_xprofile_change_field_visibility' ) ) : ?>
					<p class="field-visibility-settings-toggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>">
						<?php printf( __( 'This field can be seen by: <span class="current-visibility-level">%s</span>', 'wplms_modern' ), bp_get_the_profile_field_visibility_level_label() ) ?> <a href="#" class="visibility-toggle-link"><?php _e( 'Change', 'wplms_modern' ); ?></a>
					</p>
	...
	<div class="submit">
		<input type="submit" name="profile-group-edit-submit" id="profile-group-edit-submit" value="<?php _e( 'Save Changes', 'wplms_modern' ); ?> " />
	</div>
