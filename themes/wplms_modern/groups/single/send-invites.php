...
<?php if ( bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
	...
	<form action="<?php bp_group_send_invite_form_action(); ?>" method="post" id="send-invite-form" class="standard-form" role="main">
			...
			<?php if ( bp_group_has_invites() ) : ?>
				...
				<?php while ( bp_group_invites() ) : bp_group_the_invite(); ?>
					...
					<li id="<?php bp_group_invite_item_id(); ?>">
						...
						<div class="action">
							<a class="button remove" href="<?php bp_group_invite_user_remove_invite_url(); ?>" id="<?php bp_group_invite_item_id(); ?>"><?php _e( 'Remove Invite', 'wplms_modern' ); ?></a>
		...
		<div class="submit">
			<input type="submit" name="submit" id="submit" value="<?php _e( 'Send Invites', 'wplms_modern' ); ?>" />
		</div>
