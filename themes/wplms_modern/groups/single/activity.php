<?php 
do_action('bp_group_before_activity');
?>
<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
	<ul>
		<li class="feed"><a href="<?php bp_group_activity_feed_link(); ?>" title="<?php _e( 'RSS Feed', 'wplms_modern' ); ?>"><?php _e( 'RSS', 'wplms_modern' ); ?></a></li>
