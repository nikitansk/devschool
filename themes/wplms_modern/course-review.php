...
<div class="review_breakup">
  ...
  <div class="col-md-4">
    <div class="rating_snapshot">
      <h2><?php echo (($average_rating)?$average_rating:__('N.A','wplms_modern')); ?></h2>
      <?php
  ...
  <div class="col-md-8">
    ...
    <?php
      foreach($ratings as $k => $rating){
        echo '<li><span>'.$k.' '.__('stars','wplms_modern').'</span><strong><span style="width:'.(100*$rating/5).'%">'.$rating.'</span></strong></li>';
      }
    ?>
    </ul>
  </div>
