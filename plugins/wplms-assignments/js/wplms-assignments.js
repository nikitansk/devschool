...
jQuery(document).ready(function($){
  ...
  $('.course.submissions #assignment').on('loaded',function(){
    ...
    $('.evaluate_assignment_user').click(function(event){
      ...
      $.ajax({
              ...
              success: function (html) {
                  ...
                  CrayonSyntax.init();
                  var editor_html = $('#custom_editor').html();
                  $('#add_unit_comment #wp-mycustomeditor-wrap').remove();
                  $('#add_unit_comment').prepend(editor_html);
                  $('#custom_editor').remove();
...
$('#discussion').each(function(){
      ...
      $('body').delegate('.unit_content .commentlist li .reply','click',function(){
          ...
          form.find('.post_question').attr('data-parent',$reply.attr('data-parent'));
      ...
      $('#add_unit_comment .cancel').click(function(){
       ...
       $('.post_question').on('click',function(e){ 
            ...
            var val;
            var user_id_comment = $('#discussion').attr('data-user');
