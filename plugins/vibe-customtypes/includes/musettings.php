...
class lms_settings{
	...
	function lms_general_settings(){
		...
		array(
	            'label' => __('Enable Create course button in instrcutor profile menu', 'vibe-customtypes'),
	            'name' => 'enable_inst_create_course',
	            'desc' => __('Adds a create course link in intrutor profile menu', 'vibe-customtypes'),
	            'type' => 'checkbox',
			),
		array(
