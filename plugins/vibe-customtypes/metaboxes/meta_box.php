...
class custom_add_meta_box {
	...
	function admin_enqueue_scripts() {
		...
		if(in_array($post_type,array('course','quiz','unit','news','wplms-assignment','question'))){
	...
	function persistent_admin_scripts(){
			...
			wp_enqueue_script( 'meta_box_js', VIBE_PLUGIN_URL . '/vibe-customtypes/metaboxes/js/scripts.js', array( 'jquery','iris','select2','jquery-ui-core','jquery-ui-sortable','jquery-ui-slider','jquery-ui-datepicker') );
