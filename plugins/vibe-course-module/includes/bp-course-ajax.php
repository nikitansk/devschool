  ...
  function wplms_check_user_quiz_results(){
    ...
    function select_users(){
      ...
      if (!empty($users)) {
          ...
          echo _x('No Users found !','No users found in Course - admin - add users area','vibe');
      }
      die();
    }
...
// After begin quiz, get unmarked quesitons
    ...
    function wplms_add_unit_comment(){
      ...
      if(is_numeric($comment_id)){
        add_comment_meta( $comment_id, 'user_id_comment', $user_id_comment, false );
