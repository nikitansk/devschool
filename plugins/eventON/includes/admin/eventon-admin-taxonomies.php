		...
		// Edit term page
			function eventon_taxonomy_edit_meta_field($term) {
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="term_meta[location_lat]" id="term_meta[location_lat]" value="<?php echo esc_attr( !empty($term_meta['location_lat']) ) ? esc_attr( $term_meta['location_lat'] ) : ''; ?>">
						<p class="description"><?php _e( '(Optional) latitude for address','eventon' ); ?></p>
					</td>
				</tr>
				<tr class="form-field">
					...
					<td>
						<input type="text" name="term_meta[location_lon]" id="term_meta[location_lon]" value="<?php echo esc_attr( !empty($term_meta['location_lon']) ) ? esc_attr( $term_meta['location_lon'] ) : ''; ?>">
						<p class="description"><?php _e( '(Optional) longitude for address','eventon' ); ?></p>
					</td>
				</tr>
		...
		// Edit term
			function eventon_taxonomy_edit_meta_field_org($term) {
				...
				<th scope="row" valign="top"><label for="term_meta[evcal_org_exlink]"><?php _e( 'Link to the organizers page', 'eventon' ); ?></label></th>
					<td>
						<input type="text" name="term_meta[evcal_org_exlink]" id="term_meta[evcal_org_exlink]" value="<?php echo esc_attr( !empty($term_meta['evcal_org_exlink']) ) ? esc_attr( $term_meta['evcal_org_exlink'] ) : ''; ?>">
						<p class="description"><?php _e( 'Use this field to link organizer to other user profile pages','eventon' ); ?></p>
					</td>
				</tr>
				<tr class="form-field">
