			...
			foreach($cpav['fields'] as $field){
				...
				switch ($field['type']){
					...
					case 'image':
						...
						$rightside.= "<div id='pa_".$field['id']."'><p class='nylon_img'>".$field['name'].$legend_code."</p>";
					...
					case 'password':
						...
						$rightside.= "<p>".__($field['name'],$ajde->domain).$legend_code."</p><p><span class='nfe_f_width'><input type='password' name='".$field['id']."'";
						$rightside.= 'value="'.$FIELDVALUE.'"';
						$rightside.= $default_value."/></span></p>";
					break;
					case 'textarea':						
